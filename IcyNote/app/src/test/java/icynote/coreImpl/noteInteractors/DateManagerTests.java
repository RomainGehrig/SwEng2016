...
public class DateManagerTests extends NoteTests {

    @Override
    protected Note addInteractor(Note data) {
        return new NullInputChecker(new DateManager(data));
    }
    ...
    public void setCreation() {
        ...
        assertEquals("check old value", toTest.getCreation(), super.originalCreation);
    }
    ...
    public void setLastUpdate() {
        ...
        assertNotNull("response is not null", r);
        assertFalse("response is negative", r.isPositive());
        assertEquals("check old value", toTest.getLastUpdate(), super.originalUpdate);
    }
    ...
    private Note getBlockedNote() {
        ...
        NoteInteractor blocker = new NoteInteractor(data) {
            @Override
            public Response setLastUpdate(GregorianCalendar c) {
                return ResponseFactory.negativeResponse();
            }
        };
        return new DateManager(blocker);
    }
}
