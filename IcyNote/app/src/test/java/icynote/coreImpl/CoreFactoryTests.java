...
public class CoreFactoryTests {
    @Test
    public void coreCanBeCreated() throws Exception {
        icynote.core.IcyNoteCore c = CoreFactory.core(new ListStorage());
        assertNotNull(c);
    }

    @Test
    public void notesHaveDateValidationLogic() throws Exception {
        icynote.core.IcyNoteCore c = CoreFactory.core(new ListStorage());
    ...
    public void notesHaveNullChecks() throws Exception {
        icynote.core.IcyNoteCore c = CoreFactory.core(new ListStorage());
