...
/*public class SpannableAdapterProviderTest extends NoteProviderTests {

    @Override
    protected NoteProvider makeNew() {
        return new SpannableAdapterProvider(new ListNoteProvider());
    }
    ...
    protected NoteProvider makeNewWith(Note<String> n1, Note<String> n2, Note<String> n3) {
        ...
        return new SpannableAdapterProvider(listNoteProvider);
    }
